...
root = "C:/Users/3584175/environements/getting-started-software-development-cisco-devnet/03/demos/m3/"

# Toggle between JSON, YAML, and XML for testing
# path = f'{root}/data/db.yml'
path = f'{root}/data/db.xml'
# path = f'{root}/data/db.json'
db = Database(path)
